                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: const Text(
                        ...
                        " ciegamente.\n- Esta app es un detector de noticias falsas, NO ES UN LLM, si bien está construido a partir de uno, no se comporta"
                        " como tal, por lo que la manera correcta de usarla es introducir un titular de noticia o un acontecimiento leido en redes sociales"
                        " con el fin de saber si en verdad ocurrió. No funcionará bien si se le hacen preguntas, ni tampoco reaccionará si se le pide que"
                        " haga algo que no sea analizar un titular.\n\nSISTEMA DE CRÉDITOS:\nCada análisis gasta un crédito, y para conseguir más se compra"
                        " un paquete. Al crear una cuenta se incluyen 20 créditos gratuitos.\nRecomendación: probar bien la app con esos 20 créditos y si"
                        " la app resulta útil, evaluar si vale la pena obtener más.\n\nIMPORTANTE\nPor favor, cualquier tipo de error encontrado en la app"
                        " (ya sea en la verificación del titular, en la interfaz o en la conexión al servidor) comunicar a fake.news.detector.support@gmail.com"
